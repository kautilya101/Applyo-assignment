        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-5">
          <div>
            ...
            <input
              ...
              type="email"
              className="w-full border border-gray-300 text-zinc-800 px-4 py-2 rounded focus:outline-none"
          ...
          <div>
            ...
            <input
              ...
              type="password"
              className="w-full border text-zinc-800 border-gray-300 px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="********"
            />
            {errors.password && (
              <p className="text-red-500 text-sm mt-1">
